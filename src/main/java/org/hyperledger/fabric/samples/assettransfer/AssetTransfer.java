...
public final class AssetTransfer implements ContractInterface {
    ...
    /**
     * Duplicates a given asset on the ledger.
     *
     * @param ctx the transaction context.
     * @param oldAssetID the id of the asset being duplicated.
     * @param newAssetID the id of the new duplicated asset.
     * @param owner the owner of the new duplicated asset.
    ...
    public Asset DuplicateAsset(final Context ctx, final String oldAssetID, final String newAssetID, final String owner) {
        Asset prevAsset = ReadAsset(ctx, oldAssetID);
        Asset newAsset = CreateAsset(ctx, newAssetID, prevAsset.getColor(), prevAsset.getSize(), owner, prevAsset.getAppraisedValue());
        return newAsset;
    }
}
